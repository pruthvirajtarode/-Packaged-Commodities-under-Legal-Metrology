  ...
  return (
    <div className="min-h-screen flex flex-col relative text-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen items-center">
        ...
        {/* Transparent Header */}
        <header className="w-full max-w-7xl px-8 py-6 flex justify-between items-center mt-4">
          <div className="flex items-center gap-2">
            <div className="bg-orange-500 p-2 rounded-lg shadow-lg shadow-orange-500/20">
              <ShieldCheck className="h-6 w-6 text-white" />
            </div>
            <h1 className="text-2xl font-bold tracking-wider">PackSure AI</h1>
          </div>
        ...
        <main className="flex-1 w-full max-w-7xl px-8 flex flex-col items-center justify-center py-20 text-center">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight max-w-4xl mb-6 font-serif drop-shadow-xl leading-tight">
            Verify Product Labels.<br/>
            <span className="text-orange-400 italic font-medium">Before They Reach Consumers.</span>
          </h2>
          <p className="text-xl text-slate-200 max-w-2xl mb-12 leading-relaxed drop-shadow-md">
          ...
          <div className="flex gap-6">
            <Link href="/inspections/new">
              <Button size="lg" className="h-14 px-8 text-lg bg-orange-500 hover:bg-orange-600 text-white shadow-xl shadow-orange-500/20 border-0 transition-all hover:scale-105">
                <ScanLine className="mr-2 h-5 w-5" /> Start Live Scan
              </Button>
            </Link>
            <Link href="/dashboard">
              <Button size="lg" variant="outline" className="h-14 px-8 text-lg bg-black/40 hover:bg-black/60 border-white/20 text-white backdrop-blur-md transition-all">
